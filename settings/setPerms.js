...
const commands = await client.guilds.cache.get(process.env.BOT_GUILD_ID)?.commands
...
await client.guilds.cache.get(process.env.BOT_GUILD_ID)?.commands.permissions.set({ fullPermissions });
